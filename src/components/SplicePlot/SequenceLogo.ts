...
export class SequenceLogo {
    ...
    private createLetterPath(letter: string): string {
        ...
        const paths: { [key: string]: string } = {
            ...
            'G': 'M100,25 C100,10 90,0 50,0 C10,0 0,25 0,50 C0,75 10,100 50,100 C90,100 100,90 100,75 L100,50 L60,50 L60,65 L75,65 L75,75 C75,85 70,90 50,90 C30,90 25,75 25,50 C25,25 30,10 50,10 C70,10 75,15 75,25 Z',
